...
"""
   ...
   #pmTwo = "source/Grid/GridMain/AMR/Paramesh2"
   pmFour = "source/Grid/GridMain/AMR/Paramesh4"
   pmFourKernel = "source/Grid/GridMain/AMR/Paramesh4/PM4_package"
   pmInterp = "source/Grid/GridMain/AMR/Paramesh4/interpolation/"
   ...
   #generalexcludes = [pmTwo, ]
   
   excludes = [pmFourKernel, pmInterp,
   ...
   regexps = {
       ...
       "implNone"    : r"""^(\s*\bimplicit\s+none|\s*#\s*include\s*['"]Flashx_mpi_implicitNone[.])""",
       "blankLine"   : r"^\s*(!.*)?$",
   ...
   def commonBlock_F90(self,lines):
       exceptions = ["source/Grid/GridMain/AMR/Paramesh4/interpolation/prolong/amr_prolong_gen_work1_fun.F90",
                     "source/Grid/GridMain/AMR/Paramesh4/interpolation/prolong/amr_prolong_gen_unk1_fun.F90"]
