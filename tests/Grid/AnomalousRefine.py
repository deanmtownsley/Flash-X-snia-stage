...
if __name__ == "__main__":
    ...
    image = maple.Image(name='grid',base='akashdhruv/amrex:latest',backend='docker')
    ...
    container = maple.Container(name='anomalous_refine',target='/home/mount/FlashX')
    ...
    container.run(image,"./setup unitTest/Grid/AnomalousRefine -site=container -auto -2d \
                         +spherical +amrex -nxb=8 -nyb=8 -unit=IO/IOMain/hdf5/serial/AM && \
