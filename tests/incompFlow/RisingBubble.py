...
if __name__ == "__main__":
    ...
    image = maple.Image(name='incomp_flow',base='docker://akashdhruv/flash:latest',backend='singularity')
    ...
    container.run(image,"./setup incompFlow/RisingBubble -auto -2d -site=/home/site \
                         +amrex -maxblocks=100 && \
