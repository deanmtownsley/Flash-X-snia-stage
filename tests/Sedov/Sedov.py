...
if __name__ == "__main__":
    ...
    image = maple.Image(name='sedov',base='akashdhruv/flashx:latest',backend='docker')
    ...
    container = maple.Container(name='sedov',target='/home/mount/Flash-X')
    ...
    container.run(image,"./setup Sedov -auto -debug +parallelIO -site=/home/site && \
