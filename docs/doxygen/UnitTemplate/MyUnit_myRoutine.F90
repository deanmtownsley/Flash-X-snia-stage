...
The documentation in @details should be the general, universal contract that the
code establishes with its users.  Developers of concrete implementations of this
code need to make certain that their implementations satisfy this contract.  If
their implementation requires alteration of this contract, then the stub
documentation should be updated to reflect the change and developers of all other
implementations notified of the change.
...
!!
!! @details
!! <Add in detailed implementation-agnostic interface documentation.>
!!
