...
subroutine apply_rad_source_terms(dt)
  ...
  use Particles_data, only : a_rad, mH
        ...
        do i = blkLimits(LOW,IAXIS), blkLimits(HIGH,IAXIS)
          ...
          if (pt_is_thermally_coupled) then
            ...
            solnVec(ENER_VAR,i,j,k) = solnVec(ENER_VAR,i,j,k)&
                                       ...
                                       + solnVec(EMIE_VAR,i,j,k)
#ifdef YE_MSCALAR
            solnVec(YE_MSCALAR,i,j,k) = solnVec(YE_MSCALAR,i,j,k)&
                                          + solnVec(ABSL_VAR,i,j,k)/solnVec(DENS_VAR,i,j,k)*mH&
                                          + solnVec(EMIL_VAR,i,j,k)/solnVec(DENS_VAR,i,j,k)*mH
#endif
