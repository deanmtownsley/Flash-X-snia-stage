...
#include "Multispecies.h"
  ...
  !! atomic number. 
  !! We expect the Simulation.h file to have created numElect+1 placeholders
  ...
  !! included element is oxygen then we expect the species list in Simulation.h 
  !! to read as follows :
  !! #define H_SPEC 1
  !! #define E_SPEC 2         !In our Simulation.h we will have E_SPEC 1, H_SPEC 2
  !! #define HE_SPEC 3
  !! #define HE1_SPEC 4
  !! #define HE2_SPEC 5
  !! #define O_SPEC 6
