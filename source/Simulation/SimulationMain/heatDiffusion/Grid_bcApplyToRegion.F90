!!****if* source/Simulation/SimulationMain/heatDiffusion/Grid_bcApplyToRegion
!!
!! NAME
  ...
  do ivar = 1,varCount
     ...
     if(face==LOW) then
           ...
           case (TEMP_VAR)
              ...
              if(bcType == DIRICHLET) then
                do i = 1,guard
                   regionData(i,1:je,1:ke,ivar)= 2.0-regionData(k-i,1:je,1:ke,ivar)
                end do
              else
                do i = 1,guard
    ...
    if(face==HIGH) then
           ...
           case(TEMP_VAR)
              ...
              if(bcType == DIRICHLET) then
                do i = 1,guard
                   regionData(k-i,1:je,1:ke,ivar)= 2.0-regionData(i,1:je,1:ke,ivar)
                end do
              else
                do i = 1,guard
