!!****if* source/Simulation/SimulationMain/CCSN_Chimera_Michael/gr_mpolefiles/gr_mpoleMom2Dspherical
!!
!! NAME
!!
...
!
     ...
     do jF = 0, jFmax, 2                                          ! loop over local j face indices
      ...
      do iC = imin, imax                                          ! loop over all radial cells
       ...
       x = Rsph * thetaSine ! - gr_mpoleXcenter (which is zero)
       z = Rsph * thetaCosine - gr_mpoleZcenter
       xpm = Rsph * thetaSine - gr_mpolePtXpos
