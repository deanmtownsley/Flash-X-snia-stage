!!****if* source/Grid/GridSolvers/Multipole_new/gr_mpoleMomBins3Dspherical
!!
!! NAME
!!
!!  gr_mpoleMomBins3Dspherical
!!
!! SYNOPSIS
!!
!!  gr_mpoleMomBins3Dspherical (integer (in) :: maxQtype)
!!
!! DESCRIPTION
!!
!!  Compute the multipole moments of the density distribution in 3D spherical
...
!           The 3D spherical case. The full set of moments for:
!
!                          0 =< L =< gr_mpoleMaxL
!                          0 =< M =< L (cosine part)
!                          1 =< M =< L (sine part)
