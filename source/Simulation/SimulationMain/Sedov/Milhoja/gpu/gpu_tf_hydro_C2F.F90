...
C_hydro_op1_flZ_d) bind(c)
	...
	CALL C_F_POINTER(C_U_d, F_U_d, shape=[16 + 2 * 1 * MILHOJA_K1D, 16 + 2 * 1 * MILHOJA_K2D, 16 + 2 * 1 * MILHOJA_K3D, 9 + 1 - 0, F_nTiles_h])
	CALL C_F_POINTER(C_hydro_op1_auxc_d, F_hydro_op1_auxc_d, shape=[18, 18, 18, F_nTiles_h])
	CALL C_F_POINTER(C_hydro_op1_flX_d, F_hydro_op1_flX_d, shape=[19, 18, 18, 5, F_nTiles_h])
	CALL C_F_POINTER(C_hydro_op1_flY_d, F_hydro_op1_flY_d, shape=[18, 19, 18, 5, F_nTiles_h])
	CALL C_F_POINTER(C_hydro_op1_flZ_d, F_hydro_op1_flZ_d, shape=[18, 18, 19, 5, F_nTiles_h])
