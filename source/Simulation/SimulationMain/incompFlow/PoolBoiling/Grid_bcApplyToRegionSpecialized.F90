!!****iff* source/Simulation/SimulationMain/incompFlow/PoolBoiling/Grid_bcApplyToRegionSpecialized
...
#include "Simulation.h"
  ...
  use sim_heaterInterface,      ONLY : sim_heaterApplyBCToFace
     ...
     if(mask(ivar)) then ! Level 2
        ...
        if(face == LOW) then ! Level 3
         ...
         if(axis == IAXIS) then ! Level 3a
            ...
            call sim_heaterApplyBCToFace(level,ivar,gridDataStruct,regionData,coordinates,regionSize,&
