!!****if* source/Simulation/SimulationMain/incompFlow/ImpingingJet/Simulation_init
!! NOTICE
...
subroutine Simulation_init()
   ...
   call RuntimeParameters_get('sim_freeSurface', sim_freeSurface)
   ...
   if (sim_meshMe .eq. MASTER_PE) then
      ...
      write (*, *) 'sim_freeSurface =', sim_freeSurface
   end if
