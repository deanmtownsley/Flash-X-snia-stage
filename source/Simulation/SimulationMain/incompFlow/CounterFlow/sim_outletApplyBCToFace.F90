!!***if* source/Simulation/SimulationMain/incompFlow/CounterFlow/sim_outletApplyBCToFace
!!
!! NOTICE
...
subroutine sim_outletApplyBCToFace(level, ivar, gridDataStruct, regionData, coordinates, regionSize, &
   ...
   use Simulation_data, ONLY: sim_xMin, sim_xMax, sim_yMin, sim_yMax, sim_channelDepth
      ...
      do k = 1, ke
         do j = 1, je
            do i = 1, guard
               ...
               bcVal = coordinates(i, j, k, JAXIS) - sim_yMin - sim_channelDepth

               regionData(offset - i, j, k, ivar) = 2*bcVal - regionData(i, j, k, ivar)
