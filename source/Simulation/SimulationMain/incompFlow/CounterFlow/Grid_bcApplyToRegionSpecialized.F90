!!****if* source/Simulation/SimulationMain/incompFlow/CounterFlow/Grid_bcApplyToRegionSpecialized
!! NOTICE
...
#include "Simulation.h"
   ...
   use sim_outletInterface, ONLY: sim_outletApplyBCToFace
   ...
   do ivar = 1, varCount ! Level 1
      ...
      if (gridDataStruct /= CENTER .or. ivar /= DFUN_VAR) cycle
      ...
      if (mask(ivar)) then ! Level 2
         ...
         if (face == LOW) then ! Level 3
            ...
            if (axis == IAXIS) then ! Level 3b
               ...
               call sim_outletApplyBCToFace(level, ivar, gridDataStruct, regionData, coordinates, regionSize, &
                                            guard, face, axis, secondDir, thirdDir)
