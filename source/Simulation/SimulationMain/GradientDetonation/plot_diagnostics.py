...
axlowmid.plot(dd4['index','x'],dd4['flash','c12 '], label='c12', color='blue')
axlowmid.plot(dd4['index','x'],dd4['flash','ne20'], label='ne20', color='green')
axlowmid.plot(dd4['index','x'],dd4['flash','mg24'], label='mg24', color='red')
axlowmid.plot(dd4['index','x'],dd4['flash','si28'], label='si28', color='cyan')
axlowmid.plot(dd4['index','x'],dd4['flash','ni56'], label='ni56', color='magenta')
