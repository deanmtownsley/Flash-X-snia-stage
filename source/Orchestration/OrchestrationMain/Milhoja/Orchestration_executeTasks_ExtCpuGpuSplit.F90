...
subroutine Orchestration_executeTasks_ExtCpuGpuSplit(MH_tileTaskFunction,     &
    ...
    use milhoja_runtime_mod, ONLY : milhoja_runtime_executeTasks_ExtCpuGpuSplit
#endif
...
#ifdef RUNTIME_CAN_USE_TILEITER
    CALL milhoja_runtime_executeTasks_ExtCpuGpuSplit(MH_tileTaskFunction,     &
                                                     MH_pktTaskFunction,      &
                                                     MH_postTileTaskFunction, &
                                                     ...
                                                     MH_postTileProto_Cptr,   &
                                                     MH_ierr)
    CALL Orchestration_checkInternalError("Orchestration_executeTasks_ExtCpuGpuSplit", MH_ierr)
#else
    CALL Driver_abort("Orchestration_executeTasks_ExtCpuGpuSplit: milhoja_runtime_executeTasks_ExtCpuGpuSplit disabled")
#endif
