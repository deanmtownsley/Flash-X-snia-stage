...
! get representative ne_frac
  call RuntimeParameters_get("rep_ne22_frac", X_Ne22)
  call RuntimeParameters_get("rep_ne20_frac", X_Ne20)
...
!     write(*,*)'alan: calling bn_paraFuelAshProperties x_ne20 x_ne22 =',X_Ne20,X_Ne22
     call bn_paraFuelAshProperties(X_C12,X_Ne20,X_Ne22,ye_u,ye_b,yi_u,yi_b,q_u,q_b)
!     write(*,*)'alan: called bn_paraFuelAshProperties'
     q = (q_b - q_u)*MeVperAMUtoErgperGram
!     temp_u = 1.0e8
!     write(*,*)'alan: calling eosData_u'
     eosData_u(EOS_TEMP) = 1.0e8
!     write(*,*)'alan: called eosData_u'
!     ye_u = 0.5
     ! assume CO mixture
