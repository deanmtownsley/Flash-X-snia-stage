...
#include "Flash.h"
  ...
  integer :: ne20ii = NE0I_MSCALAR-SPECIES_BEGIN+1
  integer :: ne22ii = NE2I_MSCALAR-SPECIES_BEGIN+1
  ...
  do i = 1, ubound(solnScalars,2)
     ...
     if ( .not. (abarData(i) > 0.0 ) ) then
        ...
        write (6,*) solnScalars(c12ii,i), solnScalars(ne20ii,i), solnScalars(ne22ii,i), solnScalars(phifai,i), &
