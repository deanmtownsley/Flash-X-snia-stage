...
#include "Eos.h"
  ...
  real, intent(in)    :: xc12init, xne20init, xne22init
  ...
  !inverse timestep
  dti    = 1.e0/dt
  call bn_paraFuelAshProperties(xc12init, xne20init, xne22init, ye_f, ye_a, yi_f, yi_a, qbar_f, qbar_a)
