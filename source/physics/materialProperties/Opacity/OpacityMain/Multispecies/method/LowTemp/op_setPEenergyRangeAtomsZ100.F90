...
!
  ...
  if (.not.arrayExists) then
       call Driver_abort ('[op_setPEenergyRangeAtomsZ100] ERROR: array op_PEenergyRange not allocated')
  end if
  ...
  if (.not.goodShape) then
       call Driver_abort ('[op_setPEenergyRangeAtomsZ100] ERROR: array op_PEenergyRange has bad shape')
  end if
!
!
