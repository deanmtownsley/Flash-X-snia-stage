...
!! DESCRIPTION
!!
!! Computes the log of Lambda (Coulomb logarithm) for anisotropic electron conductivity.
!! Used by Anisotropic Conductivity, see there for further comments.
!!
!! ARGUMENTS
!!
!!   tele      :   electron temperature
!!   nele      :   electron number density
!!   tion      :   ion temperature, unused by this implementation
!!   zbar      :   Zbar
!!   ll        :   log of Lambda
!!
!! SEE ALSO
...
!!
!! NOTES
!!  DEV: It seems this separate implementation here is not needed any more.
!!  But the shared implementation one level up may change, so keep this one here.
!!***
...
subroutine cond_logLambda(tele, nele, tion, zbar, ll)
  ...
  real, intent(in)  :: tion ! ion temperature [K] - unused
