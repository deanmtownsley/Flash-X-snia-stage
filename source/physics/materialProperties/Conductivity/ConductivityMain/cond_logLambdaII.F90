!!****if* source/physics/materialProperties/Conductivity/ConductivityMain/cond_logLambdaII
!!
!! NAME
!!
!!  cond_logLambdaII
...
!! DESCRIPTION
!!
!! Computes log lambda for the ion thermal conduction
!!
...
#include "constants.h"
  ...
  use cond_commonData, ONLY: cond_boltz
  use cond_commonData, ONLY: cond_qele
  implicit none
