!!****if* source/physics/materialProperties/Conductivity/ConductivityMain/cond_logLambda
!!
!! NAME
!!
!!  cond_logLambda
...
!! DESCRIPTION
!!
!! Computes the log of Lambda (Coulomb logarithm) for electron conductivity.
!!
!! Used in connection with Conductivity implementations that do not provide
!! their own variant.
!!
!! ARGUMENTS
!!
...
subroutine cond_logLambda(tele, nele, tion, zbar, ll)
  use cond_commonData, ONLY: cond_mele, cond_boltz, cond_hbar, cond_qele
  implicit none
