...
#include "constants.h"
  ...
  call RuntimeParameters_get("nse_presTableName", prestablename)
  call RuntimeParameters_get("nse_densTableName", denstablename)
  ...
  call Logfile_stampMessage('[NSE_init] Table of NSE final state at pressure initialized.')
  ...
  call Logfile_stampMessage('[NSE_init] Table of NSE final state at density initialized.')
