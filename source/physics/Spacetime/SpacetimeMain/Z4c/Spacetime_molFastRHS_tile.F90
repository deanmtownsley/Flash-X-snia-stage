   ...
   do k = lim(LOW, KAXIS), lim(HIGH, KAXIS)
      do j = lim(LOW, JAXIS), lim(HIGH, JAXIS)
         do i = lim(LOW, IAXIS), lim(HIGH, IAXIS)
            ...
            RTF_LL_00 = R_LL_00 - Rsclr*gam_LL_00/3d0
            RTF_LL_01 = R_LL_01 - Rsclr*gam_LL_01/3d0
            RTF_LL_02 = R_LL_02 - Rsclr*gam_LL_02/3d0
            RTF_LL_11 = R_LL_11 - Rsclr*gam_LL_11/3d0
            RTF_LL_12 = R_LL_12 - Rsclr*gam_LL_12/3d0
            RTF_LL_22 = R_LL_22 - Rsclr*gam_LL_22/3d0

            CovDtildebeta_UL_00 = BETA_U_0*Gamtilde_ULL_000 + BETA_U_1*Gamtilde_ULL_001 + &
                                  BETA_U_2*Gamtilde_ULL_002 + dDBETA_UL_00
            CovDtildebeta_UL_01 = BETA_U_0*Gamtilde_ULL_001 + BETA_U_1*Gamtilde_ULL_011 + &
                                  BETA_U_2*Gamtilde_ULL_012 + dDBETA_UL_01
            CovDtildebeta_UL_02 = BETA_U_0*Gamtilde_ULL_002 + BETA_U_1*Gamtilde_ULL_012 + &
                                  BETA_U_2*Gamtilde_ULL_022 + dDBETA_UL_02
            CovDtildebeta_UL_10 = BETA_U_0*Gamtilde_ULL_100 + BETA_U_1*Gamtilde_ULL_101 + &
                                  BETA_U_2*Gamtilde_ULL_102 + dDBETA_UL_10
            CovDtildebeta_UL_11 = BETA_U_0*Gamtilde_ULL_101 + BETA_U_1*Gamtilde_ULL_111 + &
                                  BETA_U_2*Gamtilde_ULL_112 + dDBETA_UL_11
            CovDtildebeta_UL_12 = BETA_U_0*Gamtilde_ULL_102 + BETA_U_1*Gamtilde_ULL_112 + &
                                  BETA_U_2*Gamtilde_ULL_122 + dDBETA_UL_12
            CovDtildebeta_UL_20 = BETA_U_0*Gamtilde_ULL_200 + BETA_U_1*Gamtilde_ULL_201 + &
                                  BETA_U_2*Gamtilde_ULL_202 + dDBETA_UL_20
            CovDtildebeta_UL_21 = BETA_U_0*Gamtilde_ULL_201 + BETA_U_1*Gamtilde_ULL_211 + &
                                  BETA_U_2*Gamtilde_ULL_212 + dDBETA_UL_21
            CovDtildebeta_UL_22 = BETA_U_0*Gamtilde_ULL_202 + BETA_U_1*Gamtilde_ULL_212 + &
                                  BETA_U_2*Gamtilde_ULL_222 + dDBETA_UL_22

            divTildebeta = CovDtildebeta_UL_00 + CovDtildebeta_UL_11 + CovDtildebeta_UL_22

            rhs(CHI_RHS, i, j, k) = AdvDBETACHI + &
                                    (2.0d0/3.0d0)*CHI*(ALPHA*(KHAT + 2*THETAFUNC) - divTildebeta) + KOSigma*dKODCHI

            rhs(GAMTILDE_LL_00_RHS, i, j, k) = -2*ALPHA*ATILDE_LL_00 + AdvDBETAGAMTILDE_LL_00 + KOSigma*dKODGAMTILDE_LL_00 + &
                                               GAMTILDE_LL_00*(4d0*dDBETA_UL_00 - 2d0*dDBETA_UL_11 - 2d0*dDBETA_UL_22)/3d0 + &
                                               2*(GAMTILDE_LL_01*dDBETA_UL_10 + GAMTILDE_LL_02*dDBETA_UL_20)

            rhs(GAMTILDE_LL_01_RHS, i, j, k) = -2*ALPHA*ATILDE_LL_01 + AdvDBETAGAMTILDE_LL_01 + KOSigma*dKODGAMTILDE_LL_01 + &
                                               GAMTILDE_LL_00*dDBETA_UL_01 + GAMTILDE_LL_02*dDBETA_UL_21 + &
                                               GAMTILDE_LL_01*(dDBETA_UL_00 + dDBETA_UL_11 - 2d0*dDBETA_UL_22)/3d0 + &
                                               GAMTILDE_LL_11*dDBETA_UL_10 + GAMTILDE_LL_12*dDBETA_UL_20
            rhs(GAMTILDE_LL_02_RHS, i, j, k) = -2*ALPHA*ATILDE_LL_02 + AdvDBETAGAMTILDE_LL_02 + KOSigma*dKODGAMTILDE_LL_02 + &
                                               GAMTILDE_LL_00*dDBETA_UL_02 + GAMTILDE_LL_01*dDBETA_UL_12 + &
                                               GAMTILDE_LL_02*(dDBETA_UL_00 - 2d0*dDBETA_UL_11 + dDBETA_UL_22)/3d0 + &
                                               GAMTILDE_LL_12*dDBETA_UL_10 + GAMTILDE_LL_22*dDBETA_UL_20
            rhs(GAMTILDE_LL_11_RHS, i, j, k) = -2*ALPHA*ATILDE_LL_11 + AdvDBETAGAMTILDE_LL_11 + KOSigma*dKODGAMTILDE_LL_11 + &
                                               2*(GAMTILDE_LL_01*dDBETA_UL_01 + GAMTILDE_LL_12*dDBETA_UL_21) + &
                                               GAMTILDE_LL_11*(4d0*dDBETA_UL_11 - 2d0*dDBETA_UL_00 - 2d0*dDBETA_UL_22)/3d0
            rhs(GAMTILDE_LL_12_RHS, i, j, k) = -2*ALPHA*ATILDE_LL_12 + AdvDBETAGAMTILDE_LL_12 + KOSigma*dKODGAMTILDE_LL_12 + &
                                               GAMTILDE_LL_01*dDBETA_UL_02 + GAMTILDE_LL_02*dDBETA_UL_01 + &
                                               GAMTILDE_LL_11*dDBETA_UL_12 + GAMTILDE_LL_22*dDBETA_UL_21 + &
                                               GAMTILDE_LL_12*(dDBETA_UL_11 - 2d0*dDBETA_UL_00 + dDBETA_UL_22)/3d0
            rhs(GAMTILDE_LL_22_RHS, i, j, k) = -2*ALPHA*ATILDE_LL_22 + AdvDBETAGAMTILDE_LL_22 + KOSigma*dKODGAMTILDE_LL_22 + &
                                               2*(GAMTILDE_LL_02*dDBETA_UL_02 + GAMTILDE_LL_12*dDBETA_UL_12) + &
                                               GAMTILDE_LL_22*(4d0*dDBETA_UL_22 - 2d0*dDBETA_UL_00 - 2d0*dDBETA_UL_11)/3d0

            rhs(KHAT_RHS, i, j, k) = ALPHA*ATILDE_LL_00*Atilde_UU_00 + 2*ALPHA*ATILDE_LL_01*Atilde_UU_01 + &
                                     2*ALPHA*ATILDE_LL_02*Atilde_UU_02 + ALPHA*ATILDE_LL_11*Atilde_UU_11 + &
                                     2*ALPHA*ATILDE_LL_12*Atilde_UU_12 + ALPHA*ATILDE_LL_22*Atilde_UU_22 + &
                                     ALPHA*THETAFUNC*kappa1*(1 - kappa2) + (1.0d0/3.0d0)*ALPHA*(KHAT + 2*THETAFUNC)**2 + &
                                     AdvDBETAKHAT - CovDDalpha_LL_00*invgam_UU_00 - 2*CovDDalpha_LL_01*invgam_UU_01 - &
                                     2*CovDDalpha_LL_02*invgam_UU_02 - CovDDalpha_LL_11*invgam_UU_11 - &
                                     2*CovDDalpha_LL_12*invgam_UU_12 - CovDDalpha_LL_22*invgam_UU_22 + KOSigma*dKODKHAT

            rhs(ATILDE_LL_00_RHS, i, j, k) = -2*ALPHA*ATILDE_LL_00*Atilde_UL_00 + ALPHA*ATILDE_LL_00*(KHAT + 2*THETAFUNC) - &
                                             2*ALPHA*ATILDE_LL_01*Atilde_UL_10 - 2*ALPHA*ATILDE_LL_02*Atilde_UL_20 + &
                                             (4.0d0/3.0d0)*ATILDE_LL_00*dDBETA_UL_00 - 2.0d0/3.0d0*ATILDE_LL_00*dDBETA_UL_11 - &
                                             2.0d0/3.0d0*ATILDE_LL_00*dDBETA_UL_22 + 2*ATILDE_LL_01*dDBETA_UL_10 + &
                                             2*ATILDE_LL_02*dDBETA_UL_20 + AdvDBETAATILDE_LL_00 + &
                                             CHI*(ALPHA*RTF_LL_00 - CovDDalphaTF_LL_00) + KOSigma*dKODATILDE_LL_00
            rhs(ATILDE_LL_01_RHS, i, j, k) = -2*ALPHA*ATILDE_LL_00*Atilde_UL_01 - 2*ALPHA*ATILDE_LL_01*Atilde_UL_11 + &
                                             ALPHA*ATILDE_LL_01*(KHAT + 2*THETAFUNC) - 2*ALPHA*ATILDE_LL_02*Atilde_UL_21 + &
                                             ATILDE_LL_00*dDBETA_UL_01 + (1.0d0/3.0d0)*ATILDE_LL_01*dDBETA_UL_00 + &
                                             (1.0d0/3.0d0)*ATILDE_LL_01*dDBETA_UL_11 - 2.0d0/3.0d0*ATILDE_LL_01*dDBETA_UL_22 + &
                                             ATILDE_LL_02*dDBETA_UL_21 + ATILDE_LL_11*dDBETA_UL_10 + &
                                             ATILDE_LL_12*dDBETA_UL_20 + AdvDBETAATILDE_LL_01 + &
                                             CHI*(ALPHA*RTF_LL_01 - CovDDalphaTF_LL_01) + KOSigma*dKODATILDE_LL_01
            rhs(ATILDE_LL_02_RHS, i, j, k) = -2*ALPHA*ATILDE_LL_00*Atilde_UL_02 - 2*ALPHA*ATILDE_LL_01*Atilde_UL_12 - &
                                             2*ALPHA*ATILDE_LL_02*Atilde_UL_22 + ALPHA*ATILDE_LL_02*(KHAT + 2*THETAFUNC) + &
                                             ATILDE_LL_00*dDBETA_UL_02 + ATILDE_LL_01*dDBETA_UL_12 + &
                                             (1.0d0/3.0d0)*ATILDE_LL_02*dDBETA_UL_00 - 2.0d0/3.0d0*ATILDE_LL_02*dDBETA_UL_11 + &
                                             (1.0d0/3.0d0)*ATILDE_LL_02*dDBETA_UL_22 + ATILDE_LL_12*dDBETA_UL_10 + &
                                             ATILDE_LL_22*dDBETA_UL_20 + AdvDBETAATILDE_LL_02 + &
                                             CHI*(ALPHA*RTF_LL_02 - CovDDalphaTF_LL_02) + KOSigma*dKODATILDE_LL_02
            rhs(ATILDE_LL_11_RHS, i, j, k) = -2*ALPHA*ATILDE_LL_01*Atilde_UL_01 - 2*ALPHA*ATILDE_LL_11*Atilde_UL_11 + &
                                             ALPHA*ATILDE_LL_11*(KHAT + 2*THETAFUNC) - 2*ALPHA*ATILDE_LL_12*Atilde_UL_21 + &
                                             2*ATILDE_LL_01*dDBETA_UL_01 - 2.0d0/3.0d0*ATILDE_LL_11*dDBETA_UL_00 + &
                                             (4.0d0/3.0d0)*ATILDE_LL_11*dDBETA_UL_11 - 2.0d0/3.0d0*ATILDE_LL_11*dDBETA_UL_22 + &
                                             2*ATILDE_LL_12*dDBETA_UL_21 + AdvDBETAATILDE_LL_11 + &
                                             CHI*(ALPHA*RTF_LL_11 - CovDDalphaTF_LL_11) + KOSigma*dKODATILDE_LL_11
            rhs(ATILDE_LL_12_RHS, i, j, k) = -2*ALPHA*ATILDE_LL_01*Atilde_UL_02 - 2*ALPHA*ATILDE_LL_11*Atilde_UL_12 - &
                                             2*ALPHA*ATILDE_LL_12*Atilde_UL_22 + ALPHA*ATILDE_LL_12*(KHAT + 2*THETAFUNC) + &
                                             ATILDE_LL_01*dDBETA_UL_02 + ATILDE_LL_02*dDBETA_UL_01 + &
                                             ATILDE_LL_11*dDBETA_UL_12 - 2.0d0/3.0d0*ATILDE_LL_12*dDBETA_UL_00 + &
                                             (1.0d0/3.0d0)*ATILDE_LL_12*dDBETA_UL_11 + (1.0d0/3.0d0)*ATILDE_LL_12*dDBETA_UL_22 + &
                                             ATILDE_LL_22*dDBETA_UL_21 + AdvDBETAATILDE_LL_12 + &
                                             CHI*(ALPHA*RTF_LL_12 - CovDDalphaTF_LL_12) + KOSigma*dKODATILDE_LL_12
            rhs(ATILDE_LL_22_RHS, i, j, k) = -2*ALPHA*ATILDE_LL_02*Atilde_UL_02 - 2*ALPHA*ATILDE_LL_12*Atilde_UL_12 - &
                                             2*ALPHA*ATILDE_LL_22*Atilde_UL_22 + ALPHA*ATILDE_LL_22*(KHAT + 2*THETAFUNC) + &
                                             2*ATILDE_LL_02*dDBETA_UL_02 + 2*ATILDE_LL_12*dDBETA_UL_12 - &
                                             2.0d0/3.0d0*ATILDE_LL_22*dDBETA_UL_00 - 2.0d0/3.0d0*ATILDE_LL_22*dDBETA_UL_11 + &
                                             (4.0d0/3.0d0)*ATILDE_LL_22*dDBETA_UL_22 + AdvDBETAATILDE_LL_22 + &
                                             CHI*(ALPHA*RTF_LL_22 - CovDDalphaTF_LL_22) + KOSigma*dKODATILDE_LL_22

            rhs(THETAFUNC_RHS, i, j, k) = -0.5d0*ALPHA*ATILDE_LL_00*Atilde_UU_00 - ALPHA*ATILDE_LL_01*Atilde_UU_01 - &
                                          ALPHA*ATILDE_LL_02*Atilde_UU_02 - 0.5d0*ALPHA*ATILDE_LL_11*Atilde_UU_11 - &
                                          ALPHA*ATILDE_LL_12*Atilde_UU_12 - 0.5d0*ALPHA*ATILDE_LL_22*Atilde_UU_22 + &
                                   0.5d0*ALPHA*(Rsclr - 2*THETAFUNC*kappa1*(kappa2 + 2) + (2.0d0/3.0d0)*(KHAT + 2*THETAFUNC)**2) + &
                                          AdvDBETATHETAFUNC + KOSigma*dKODTHETAFUNC

            rhs(GAMTILDE_U_0_RHS, i, j, k) = 2*ALPHA*Atilde_UU_00*Gamtilde_ULL_000 + 4*ALPHA*Atilde_UU_01*Gamtilde_ULL_001 + &
                                             4*ALPHA*Atilde_UU_02*Gamtilde_ULL_002 + 2*ALPHA*Atilde_UU_11*Gamtilde_ULL_011 + &
                                             4*ALPHA*Atilde_UU_12*Gamtilde_ULL_012 + 2*ALPHA*Atilde_UU_22*Gamtilde_ULL_022 - &
                                             2*ALPHA*kappa1*(GAMTILDE_U_0 - GamtildeD_U_0) + &
                                             2*ALPHA*(-3.0d0/2.0d0*Atilde_UU_00*dDCHI_L_0*invCHI - &
                                                      1.0d0/3.0d0*invGAMTILDE_UU_00*(2*dDKHAT_L_0 + dDTHETAFUNC_L_0)) + &
                                             2*ALPHA*(-1.5d0*Atilde_UU_01*dDCHI_L_1*invCHI - &
                                                      1.0d0/3.0d0*invGAMTILDE_UU_01*(2*dDKHAT_L_1 + dDTHETAFUNC_L_1)) + &
                                             2*ALPHA*(-1.5d0*Atilde_UU_02*dDCHI_L_2*invCHI - &
                                                      1.0d0/3.0d0*invGAMTILDE_UU_02*(2*dDKHAT_L_2 + dDTHETAFUNC_L_2)) + &
                                             AdvDBETAGAMTILDE_U_0 - 2*Atilde_UU_00*dDALPHA_L_0 - &
                                             2*Atilde_UU_01*dDALPHA_L_1 - 2*Atilde_UU_02*dDALPHA_L_2 - &
                                             1.0d0/3.0d0*GamtildeD_U_0*dDBETA_UL_00 + (2.0d0/3.0d0)*GamtildeD_U_0*dDBETA_UL_11 + &
                                             (2.0d0/3.0d0)*GamtildeD_U_0*dDBETA_UL_22 - GamtildeD_U_1*dDBETA_UL_01 - &
                                             GamtildeD_U_2*dDBETA_UL_02 + KOSigma*dKODGAMTILDE_U_0 + &
                                             (4.0d0/3.0d0)*dDDBETA_ULL_000*invGAMTILDE_UU_00 + &
                                             (7.0d0/3.0d0)*dDDBETA_ULL_001*invGAMTILDE_UU_01 + &
                                             (7.0d0/3.0d0)*dDDBETA_ULL_002*invGAMTILDE_UU_02 + &
                                             dDDBETA_ULL_011*invGAMTILDE_UU_11 + 2*dDDBETA_ULL_012*invGAMTILDE_UU_12 + &
                                             dDDBETA_ULL_022*invGAMTILDE_UU_22 + &
                                             (dDDBETA_ULL_101*invGAMTILDE_UU_00 + dDDBETA_ULL_111*invGAMTILDE_UU_01 + &
                                              dDDBETA_ULL_112*invGAMTILDE_UU_02 + dDDBETA_ULL_202*invGAMTILDE_UU_00 + &
                                              dDDBETA_ULL_212*invGAMTILDE_UU_01 + dDDBETA_ULL_222*invGAMTILDE_UU_02)/3d0
            rhs(GAMTILDE_U_1_RHS, i, j, k) = 2*ALPHA*Atilde_UU_00*Gamtilde_ULL_100 + 4*ALPHA*Atilde_UU_01*Gamtilde_ULL_101 + &
                                             4*ALPHA*Atilde_UU_02*Gamtilde_ULL_102 + 2*ALPHA*Atilde_UU_11*Gamtilde_ULL_111 + &
                                             4*ALPHA*Atilde_UU_12*Gamtilde_ULL_112 + 2*ALPHA*Atilde_UU_22*Gamtilde_ULL_122 - &
                                             2*ALPHA*kappa1*(GAMTILDE_U_1 - GamtildeD_U_1) + &
                                             2*ALPHA*(-3.0d0/2.0d0*Atilde_UU_01*dDCHI_L_0*invCHI - &
                                                      1.0d0/3.0d0*invGAMTILDE_UU_01*(2*dDKHAT_L_0 + dDTHETAFUNC_L_0)) + &
                                             2*ALPHA*(-1.5d0*Atilde_UU_11*dDCHI_L_1*invCHI - &
                                                      1.0d0/3.0d0*invGAMTILDE_UU_11*(2*dDKHAT_L_1 + dDTHETAFUNC_L_1)) + &
                                             2*ALPHA*(-1.5d0*Atilde_UU_12*dDCHI_L_2*invCHI - &
                                                      1.0d0/3.0d0*invGAMTILDE_UU_12*(2*dDKHAT_L_2 + dDTHETAFUNC_L_2)) + &
                                             AdvDBETAGAMTILDE_U_1 - 2*Atilde_UU_01*dDALPHA_L_0 - 2*Atilde_UU_11*dDALPHA_L_1 - &
                                             2*Atilde_UU_12*dDALPHA_L_2 - GamtildeD_U_0*dDBETA_UL_10 + &
                                             (2.0d0/3.0d0)*GamtildeD_U_1*dDBETA_UL_00 - &
                                             1.0d0/3.0d0*GamtildeD_U_1*dDBETA_UL_11 + &
                                             (2.0d0/3.0d0)*GamtildeD_U_1*dDBETA_UL_22 - &
                                             GamtildeD_U_2*dDBETA_UL_12 + KOSigma*dKODGAMTILDE_U_1 + &
                                             (1.0d0/3.0d0)*dDDBETA_ULL_000*invGAMTILDE_UU_01 + &
                                             (1.0d0/3.0d0)*dDDBETA_ULL_001*invGAMTILDE_UU_11 + &
                                             (1.0d0/3.0d0)*dDDBETA_ULL_002*invGAMTILDE_UU_12 + &
                                             dDDBETA_ULL_100*invGAMTILDE_UU_00 + (7.0d0/3.0d0)*dDDBETA_ULL_101*invGAMTILDE_UU_01 + &
                                             2*dDDBETA_ULL_102*invGAMTILDE_UU_02 + &
                                             (4.0d0/3.0d0)*dDDBETA_ULL_111*invGAMTILDE_UU_11 + &
                                             (7.0d0/3.0d0)*dDDBETA_ULL_112*invGAMTILDE_UU_12 + dDDBETA_ULL_122*invGAMTILDE_UU_22 + &
                                             (1.0d0/3.0d0)*dDDBETA_ULL_202*invGAMTILDE_UU_01 + &
                                             (1.0d0/3.0d0)*dDDBETA_ULL_212*invGAMTILDE_UU_11 + &
                                             (1.0d0/3.0d0)*dDDBETA_ULL_222*invGAMTILDE_UU_12
            rhs(GAMTILDE_U_2_RHS, i, j, k) = 2*ALPHA*Atilde_UU_00*Gamtilde_ULL_200 + 4*ALPHA*Atilde_UU_01*Gamtilde_ULL_201 + &
                                             4*ALPHA*Atilde_UU_02*Gamtilde_ULL_202 + 2*ALPHA*Atilde_UU_11*Gamtilde_ULL_211 + &
                                             4*ALPHA*Atilde_UU_12*Gamtilde_ULL_212 + 2*ALPHA*Atilde_UU_22*Gamtilde_ULL_222 - &
                                             2*ALPHA*kappa1*(GAMTILDE_U_2 - GamtildeD_U_2) + &
                                             2*ALPHA*(-3.0d0/2.0d0*Atilde_UU_02*dDCHI_L_0*invCHI - &
                                                      1.0d0/3.0d0*invGAMTILDE_UU_02*(2*dDKHAT_L_0 + dDTHETAFUNC_L_0)) + &
                                             2*ALPHA*(-1.5d0*Atilde_UU_12*dDCHI_L_1*invCHI - &
                                                      1.0d0/3.0d0*invGAMTILDE_UU_12*(2*dDKHAT_L_1 + dDTHETAFUNC_L_1)) + &
                                             2*ALPHA*(-1.5d0*Atilde_UU_22*dDCHI_L_2*invCHI - &
                                                      1.0d0/3.0d0*invGAMTILDE_UU_22*(2*dDKHAT_L_2 + dDTHETAFUNC_L_2)) + &
                                             AdvDBETAGAMTILDE_U_2 - 2*Atilde_UU_02*dDALPHA_L_0 - &
                                             2*Atilde_UU_12*dDALPHA_L_1 - 2*Atilde_UU_22*dDALPHA_L_2 - &
                                             GamtildeD_U_0*dDBETA_UL_20 - GamtildeD_U_1*dDBETA_UL_21 + &
                                             (2.0d0/3.0d0)*GamtildeD_U_2*dDBETA_UL_00 + (2.0d0/3.0d0)*GamtildeD_U_2*dDBETA_UL_11 - &
                                             1.0d0/3.0d0*GamtildeD_U_2*dDBETA_UL_22 + KOSigma*dKODGAMTILDE_U_2 + &
                                             (1.0d0/3.0d0)*dDDBETA_ULL_000*invGAMTILDE_UU_02 + &
                                             (1.0d0/3.0d0)*dDDBETA_ULL_001*invGAMTILDE_UU_12 + &
                                             (1.0d0/3.0d0)*dDDBETA_ULL_002*invGAMTILDE_UU_22 + &
                                             (1.0d0/3.0d0)*dDDBETA_ULL_101*invGAMTILDE_UU_02 + &
                                             (1.0d0/3.0d0)*dDDBETA_ULL_111*invGAMTILDE_UU_12 + &
                                             (1.0d0/3.0d0)*dDDBETA_ULL_112*invGAMTILDE_UU_22 + &
                                             dDDBETA_ULL_200*invGAMTILDE_UU_00 + 2*dDDBETA_ULL_201*invGAMTILDE_UU_01 + &
                                             (7.0d0/3.0d0)*dDDBETA_ULL_202*invGAMTILDE_UU_02 + &
                                             dDDBETA_ULL_211*invGAMTILDE_UU_11 + (7.0d0/3.0d0)*dDDBETA_ULL_212*invGAMTILDE_UU_12 + &
                                             (4.0d0/3.0d0)*dDDBETA_ULL_222*invGAMTILDE_UU_22
