...
!        endif
     ...
     do k = 1, vecLen
        ...
        if (ewantRow(k) < 1e12) then
            print *, 'input energy below 1e12'
            print *, 'bnd_lo, tempfound, efound, pfound:', bnd_lo(k), tempRow(k), etotRow(k), ptotRow(k)
            print *, 'den, abar, zbar:', denRow(k), abarRow(k), zbarRow(k)
        endif
