...
#include "Simulation.h"
  ...
  real(dp_t), save :: mintemp = 1.e-200_dp_t
  real(dp_t), save :: maxtemp = 1.e200_dp_t
  real(dp_t), save :: mindens = 1.e-200_dp_t
  real(dp_t), save :: maxdens = 1.e200_dp_t
  real(dp_t), save :: minx    = 1.e-200_dp_t
  real(dp_t), save :: maxx    = 1.e0_dp_t + 1.e-12_dp_t
  real(dp_t), save :: minye   = 1.e-200_dp_t
  real(dp_t), save :: maxye   = 1.e0_dp_t + 1.e-12_dp_t
  real(dp_t), save :: mine    = 1.e-200_dp_t
  real(dp_t), save :: maxe    = 1.e200_dp_t
  real(dp_t), save :: minp    = 1.e-200_dp_t
  real(dp_t), save :: maxp    = 1.e200_dp_t
  real(dp_t), save :: mins    = 1.e-200_dp_t
  real(dp_t), save :: maxs    = 1.e200_dp_t
  real(dp_t), save :: minh    = 1.e-200_dp_t
  real(dp_t), save :: maxh    = 1.e200_dp_t
  ...
  type(eos_tp) :: eos_state(GRID_IHI_GC*GRID_JHI_GC*GRID_KHI_GC*MAXBLOCKS)
  type(reduced_eos_tp) :: reduced_eos_state(GRID_IHI_GC*GRID_JHI_GC*GRID_KHI_GC*MAXBLOCKS)
  !$acc declare create(eos_state,reduced_eos_state)
...
contains
  ...
  subroutine composition(state)
    ...
    type (comp_tp), intent(inout) :: state
