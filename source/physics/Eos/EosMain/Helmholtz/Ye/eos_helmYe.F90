!!****if* source/physics/Eos/EosMain/Helmholtz/Ye/eos_helmYe
!! NOTICE
...
!! SYNOPSIS
!!
!!  call eos_helmYe(integer(IN) :: mode,
!!                     integer(IN) :: vecLen,
...
subroutine eos_helmYe(mode,vecLen,eosData,massFrac,mask,vecB,vecE,diagFlag)
