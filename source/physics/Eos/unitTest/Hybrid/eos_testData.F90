!!****ih* source/physics/Eos/unitTest/Hybrid/eos_testData
!! NOTICE
...
#include "constants.h"
   ...
   character(len=:), allocatable, save :: eos_testPresModeStr, eos_testEintModeStr, eos_testTempModeStr
