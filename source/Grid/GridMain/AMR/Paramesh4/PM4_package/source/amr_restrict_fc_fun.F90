...
!!
!!    Modified to call amr_restrict_fc_mg   Klaus Weide  Sep 2016
!!***
...
!-----Begin executable code.
      ...
      Do ivar = 1, nbndvar
         ...
         Else if (order .GE. 30 .AND. order .LE. 35) then

            Call amr_restrict_fc_ins(recv,temp,icoord,order-30,ivar)
