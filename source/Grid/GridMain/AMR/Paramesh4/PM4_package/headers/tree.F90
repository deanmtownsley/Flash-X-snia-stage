...
! Variables for controlling load distrubution behavior

      public :: gr_btSortByWork, gr_btCustomWork, gr_btExchangeWork
      public :: gr_btWorkDefaultPar,gr_btWorkDefaultLeaf
      public :: gr_btWorkBoundsPar,gr_btWorkBoundsLeaf
      public :: gr_btWorkChildScaling

      logical, save :: gr_btSortByWork, gr_btCustomWork
      logical, save :: gr_btExchangeWork
      real, save :: gr_btWorkDefaultPar,gr_btWorkDefaultLeaf
