!!****if* source/Grid/GridMain/AMR/Paramesh4/Grid_getBlkNeighBlkIDFromPos
...
!!
!!   !DEV: There is no proper implementation, will abort if called.
!!
!! SEE ALSO
...
#include "constants.h"
  ...
  call gr_findNeghID(blockDesc%id,pos,neghDir,neghID)
