!!****if* source/Grid/localAPI/gr_mpolePrintRadialInfo
...
!!  bin grid to a text file. The information is written out to a file
!!  named basenm_printRadialInfo.txt, where basenm is the runtime parameter for
