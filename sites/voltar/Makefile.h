# Flash-X Makefile header for nvhpc
#----------------------------------------------------------------------------
# Set the HDF5/MPI library paths -- these need to be updated for your system
#----------------------------------------------------------------------------

MPI_PATH   =
AMREX_PATH = ${HOME}/flashx/common/installed/amrex-23.11_nvhpc22.11/${NDIM}d
HDF5_PATH  = ${HOME}/flashx/common/installed/hdf5-1_12_2_nvhpc22.11
HYPRE_PATH =
CUDA_PATH  = ${CUDA}
MA28_PATH = 
MILHOJA_PATH = ${HOME}/flashx/common/installed/milhoja/${NDIM}d
...
OPENMP = -mp
ACC_CUDA = -Minfo=mp,accel -gpu=cc80,cuda11.8,ptxinfo
...
FFLAGS_OMP_OL= -mp=gpu ${ACC_CUDA}
FFLAGS_OACC  = -acc=gpu ${ACC_CUDA}
...
DEBUG_FLAGS  = -g -O0 -Mpreprocess -Mbounds -traceback #-gpu=redundant,autocompare

FFLAGS = -Mdclchk #-Mchkptr# -Minit-local-zero

FFLAGS_OPT   = -c ${FFLAGS} ${OPT_FLAGS}
FFLAGS_TEST  = -c ${FFLAGS} ${TEST_FLAGS}
FFLAGS_DEBUG = -c ${FFLAGS} ${DEBUG_FLAGS} -C -Mchkptr -Mchkstk 
...
CFLAGS_OMP_OL= -mp=gpu ${ACC_CUDA}
CFLAGS_OACC  = -acc=gpu ${ACC_CUDA}
...
LIB_HDF5  = -L${HDF5_PATH}/lib -lhdf5 -lhdf5_fortran -rpath=${HDF5_PATH}/lib
LIB_MATH  = ${LIB_ESSL}
LIB_HYPRE = -L${HYPRE_PATH}/lib -lHYPRE ${LIB_LAPACK}
LIB_CUDA  = -lcudart -lnvToolsExt -L${CUDA_PATH}/lib64
LIB_OMP_OL= -mp=gpu ${ACC_CUDA}
LIB_OACC = -acc=gpu ${ACC_CUDA}
LIB_MA28  = -L${MA28_PATH} -lma28
LIB_BITTREE =
LIB_MILHOJA = -L${MILHOJA_PATH}/lib -lmilhoja -lpthread -Mcuda
