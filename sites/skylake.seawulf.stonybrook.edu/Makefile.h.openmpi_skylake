...
#----------------------------------------------------------------------------
#Path that holds all the software on seawulf
SOFT_PATH   = /gpfs/software

MPI_PATH   = ${SOFT_PATH}/openmpi/gcc12.1/skylake/4.1.4
HDF4_PATH  =
HDF5_PATH  =${SOFT_PATH}/hdf5/parallel/gcc12/openmpi/1.12.2
HYPRE_PATH = 
...
FFLAGS_OPT = -c -Ofast -march=skylake -mtune=skylake -fdefault-real-8 -fdefault-double-8 \
